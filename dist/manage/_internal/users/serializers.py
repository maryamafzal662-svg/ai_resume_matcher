...
# ✅ CustomUserSerializer (for views.py import)
...
# ✅ Alternate name (if needed elsewhere)
...
class CandidateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CustomUser  # Tumhara custom user model
        fields = [
            'id',
            'username',
            'first_name',
...
class JobOfferSerializer(serializers.ModelSerializer):
    ...
    # 👇 custom field: accept strings for skills
    skills = serializers.ListField(
...
class NotificationSerializer(serializers.ModelSerializer):
    ...
    def get_message(self, obj):
        if obj.type == 'profile_incomplete':
            return "⚠️ Please upload your profile image to complete your professional profile."
