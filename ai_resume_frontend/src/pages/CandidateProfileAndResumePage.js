...
const CandidateProfileAndResumePage = () => {
  const { id } = useParams(); // Candidate's USER ID from route param
    ...
    <>
      ...
      <div style={styles.pageContainer}>
        <div style={styles.card}>
          ...
          {/* Basic Info (Username & Joined Date removed as requested) */}
          <p>
            <strong>Email:</strong>{" "}
            {profileData.email || resume?.email ? (
              <a
                href={`mailto:${profileData.email || resume?.email}`}
          ...
          <p>
            <strong>Phone:</strong>{" "}
            {profileData.phone || resume?.phone || "Not Provided"}
          </p>
          <p>
            <strong>Location:</strong>{" "}
            {profileData.location || resume?.location || "Not Provided"}
          </p>
          <p>
            <strong>Role:</strong> {profileData.role || "candidate"}
          </p>
...
const styles = {
  pageContainer: {
    ...
    backgroundColor: "#f8fafc", // Matching UserProfile background
    padding: "20px",
    paddingTop: "90px",
  },
  card: {
